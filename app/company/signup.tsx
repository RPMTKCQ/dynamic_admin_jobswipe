...
export default function CompanySignupScreen() {
  ...
  const handleSignup = () => {
    if (!name || !hr || !age || !email || !password || !confirmPassword) {
    ...
    console.log("Updated companies list:", companiesData);
  ...
  return (
    <>
      ...
      <View style={{ flex: 1, backgroundColor: "#F7F7F7", alignItems: "center" }}>
        ...
        >
          <Text style={{ color: "white", fontSize: 24, fontWeight: "bold" }}>Company Sign Up</Text>
        </View>
        ...
        <View style={{ flex: 1, width: "85%", justifyContent: "center" }}>
          ...
          <TextInput placeholder="HR Name" style={styles.input} value={hr} onChangeText={setHr} />
