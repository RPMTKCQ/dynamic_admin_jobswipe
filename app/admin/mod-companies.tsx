...
// ✅ Import company data from centralized file
import { companiesData } from "../../src/data/companiesData";

export default function AdminModCompanies() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerContent}>
        <Text style={styles.title}>Modify Companies</Text>
        <Text style={styles.count}>Total Companies: {companies.length}</Text>
      </View>
      ...
      <View style={styles.tableHeader}>
        ...
        <Text style={[styles.tableHeaderText, { flex: 1.2 }]}>HR Name</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.tableRow}>
            ...
            <Text style={[styles.tableCell, { flex: 1.2 }]}>{item.hr}</Text>
